   ...
   return (
      <section className="container py-3 admin-page">
         <PageHeader
            ...
            subtitle="Pantau tugas review, persetujuan, dan kebutuhan verifikasi yang menunggu tindakan Anda."
         />
         ...
         <div className="admin-card">
            {loading ? (
               ...
               <div className="text-muted py-3">Belum ada notifikasi untuk admin.</div>
            ) : (
                  ...
                  {sortedItems.map((item) => (
                     <div
                        ...
                        className={`border rounded-4 p-3 ${item.is_read
                              ...
                              : "bg-warning-subtle border-warning-subtle shadow-sm"
                           }`}
                     >
                        <div className="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                           <div className="d-flex align-items-start gap-2">
                              {!item.is_read && (
                                 <span
                                    className="mt-1 rounded-circle bg-warning"
                              ...
                              <div>
                                 <div className="d-flex align-items-center gap-2 mb-1 flex-wrap">
                                    <span className="small text-uppercase text-muted">Tugas</span>
                                    {!item.is_read ? (
